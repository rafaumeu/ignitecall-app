...
INSERT INTO "new_accounts" ("access_token", "id", "provider", "provider_account_id", "refresh_token", "user_id") SELECT "access_token", "id", "provider", "provider_account_id", "refresh_token", "user_id" FROM "accounts";
DROP TABLE "accounts";
